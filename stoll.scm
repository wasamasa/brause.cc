...
(define quotes
  ...
  '("Licht ist keine Grenzgeschwindigkeit, Vorsicht. Skalarwellen und stehende Welle hat ein Vielfaches mehr!"
    ...
    "Merkt ihr die Korrelation?"
    "Nachdenken!"
    "Mathematik mein lieber Mario, hö?!"
    "Man muss das dazu auch mal philosophisch betrachten."
    "Aber steigert euch nicht zu tief hinein - ich denke da an die Zahl 23 und was es alles gibt."
    ...
    "Ganz wichtig, steht auch auf dem reichsdeutschen Wissen."
    ...
    "Infometrisches Feld und infometrische Felder, Pluralis."
    ...
    "Während des dritten Reiches war Nikola Tesla hier zu Besuch."
    ...
    "In Russland nennt man das heute die skalare Haubitze."
    ...
    "Nach Möglichkeit mit wenig Blutvergießen, vergesst das bitte nicht!"
    ...
    "Fußball... Gotteswillen - Opium fürs Volk sag ich nur. Brot und Spiele. Iss was für Bekloppte."
    ...
    "Welch ein geistiger Dünnschiss sag ich da nur!"
    ...
    "Genau das haben die meisten nicht begriffen."
    "Na ja, was soll man von Mutanten erwarten?"
    ...
    "Für mich ist das der Elektrojude."
    ...
    "Ich genieße den Templerschutz und den Schutz der National Security Agency."
    ...
    "Ich bin ein Mensch, wenn ich schon Schnee sehe, kriege ich 'ne Erkältung."
    ...
    "Da komme ich mir vor wie eine tibetanische Gebetsmühle oder tausend Studenten."
